...
function Configuration() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response_2 = await axios.get(`http://127.0.0.1:5000/drinks/longdrinks.json`);
    ...
    const updateData = async (val, idx, cat, file) => {
        try {
            const response = await axios.post(`http://127.0.0.1:5000/update/${file}`, {
                value: val,
                index: idx,
                category: cat
            });
    ...
    return (
        <div className="pt-4 font-sans">
            ...
            <div className='overflow-y-auto h-[410px] scrollbar-hide' style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
                <div className='flex items-center justify-between'>
                    <div>
                        <div className='px-1 text-[18px] font-normal mb-4 mt-2'>Bechergröße</div>
                        <div className='px-1 text-[13px] text-[#95c6b7] mt-[-16px] mb-4'>{size}ml</div>
                    </div>
                    <div className='flex gap-2'>
                        <div
                            className={`flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-lg ${size === 250 ? 'bg-[#1fe0a6] text-[#12211d]' : 'bg-[#25463c]'
                                } pl-4 pr-4 active:scale-95 transition-all duration-100`}
                            onClick={() => changeValue(250, 0, 2)}
                        >
                            <p
                                className={`text-sm ${size === 250 ? 'font-bold' : 'font-medium'
                                    } leading-normal`}
                            >
                                250ml
                            </p>
                        ...
                        <div
                            className={`flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-lg ${size === 300 ? 'bg-[#1fe0a6] text-[#12211d]' : 'bg-[#25463c]'
                                } pl-4 pr-4 active:scale-95 transition-all duration-100`}
                            onClick={() => changeValue(300, 0, 2)}
                        >
                            <p
                                className={`text-sm ${size === 300 ? 'font-bold' : 'font-medium'
                                    } leading-normal`}
                            >
                                300ml
                            </p>
                        ...
                        <div
                            className={`flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-lg ${size === 350 ? 'bg-[#1fe0a6] text-[#12211d]' : 'bg-[#25463c]'
                                } pl-4 pr-4 active:scale-95 transition-all duration-100`}
                            onClick={() => changeValue(350, 0, 2)}
                        >
                            <p
                                className={`text-sm ${size === 350 ? 'font-bold' : 'font-medium'
                                    } leading-normal`}
                            >
                                350ml
                            </p>
                        ...
                        <div
                            className={`flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-lg ${size === 400 ? 'bg-[#1fe0a6] text-[#12211d]' : 'bg-[#25463c]'
                                } pl-4 pr-4 active:scale-95 transition-all duration-100`}
                            onClick={() => changeValue(400, 0, 2)}
                        >
                            <p
                                className={`text-sm ${size === 400 ? 'font-bold' : 'font-medium'
                                    } leading-normal`}
                            >
                                400ml
                            </p>
                        ...
                        <div
                            className={`flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-lg ${size === 450 ? 'bg-[#1fe0a6] text-[#12211d]' : 'bg-[#25463c]'
                                } pl-4 pr-4 active:scale-95 transition-all duration-100`}
                            onClick={() => changeValue(450, 0, 2)}
                        >
                            <p
                                className={`text-sm ${size === 450 ? 'font-bold' : 'font-medium'
                                    } leading-normal`}
                            >
                                450ml
                            </p>
                        ...
                        >
                            <p
                                className={`text-sm ${size === 500 ? 'font-bold' : 'font-medium'
                                    } leading-normal`}
                            >
                                500ml
                            </p>
                        ...
                        return (
                            ...
                            >
                                <div className="text-[18px] font-normal">
                                    {item.name}
                                    <br></br>
                                    <div className='text-[13px] text-[#95c6b7]'>{item.fuellstand_ml}ml</div>
                                    <br></br>
                                    <div className='text-[13px] text-[#95c6b7] mt-[-28px]'>Position {item.anschlussplatz}</div>
                                </div>
                                <div className='flex gap-6'>
                                    ...
                                    <select
                                        ...
                                        onChange={(ev) => changeValue(Number(ev.target.value), index, 0)}
                                    >
                                        {options.map((option) => (
